...
export default function Home() {
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet >
          <meta name="keywords" content="Better, Color, Colour, Best Colour" />
          <meta name="description" content="BetterColor is about better coloring" />
          <title>Home | BetterColor</title>
        </Helmet>
      </HelmetProvider>
